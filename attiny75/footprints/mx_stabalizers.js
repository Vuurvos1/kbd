...
module.exports = {
  ...
  body: (p) => {
    ...
    const keycap = `
			${'' /* keycap marks */}
			(fp_line (start -${9.5 * p.size} -9.5) (end ${
      9.5 * p.size
    } -9.5) (layer Dwgs.User) (width 0.15))
			(fp_line (start ${9.5 * p.size} -9.5) (end ${
      9.5 * p.size
    } 9.5) (layer Dwgs.User) (width 0.15))
			(fp_line (start ${9.5 * p.size} 9.5) (end -${
    ...
    function holes(spacing) {
      return `
				${'' /* holes */}
				(pad "" np_thru_hole circle (at -${
          spacing / 2
        } -6.985) (size 3.048 3.048) (drill 3.048) (layers *.Cu *.Mask))
				(pad "" np_thru_hole circle (at ${
          spacing / 2
        } -6.985) (size 3.048 3.048) (drill 3.048) (layers *.Cu *.Mask))
				(pad "" np_thru_hole circle (at -${
          spacing / 2
        } 8.255) (size 3.9878 3.9878) (drill 3.9878) (layers *.Cu *.Mask))
				(pad "" np_thru_hole circle (at ${
          spacing / 2
        } 8.255) (size 3.9878 3.9878) (drill 3.9878) (layers *.Cu *.Mask))
			`;
    ...
    switch (p.size) {
      ...
      case 10:
        ...
        break;
      default:
        throw new Error(`Invalid stabilizer size ${p.size}.`);
    }
